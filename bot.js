...
${chalk.blue.italic('🌐 WhatsAlexa, Connecting Via WhatsApp... Please wait a few moments..')}`);
    });
    ...
    conn.on('open', async () => {
        ...
        console.log(
            chalk.green.bold('🎉 BOT ( WhatsAlexa ) IS NOW ACTIVE IN YOUR ACCOUNT!')
        );
    });
